 ...
 */
public interface IIdtoLXPMap<T extends PersistentObject> {
    PersistentObject lookup(Long id) throws IOException, BucketException, RepositoryException;

    void put(Long key, IStoreReference<T> value) throws PersistentObjectException, BucketException;

    void injestRefMap(Map<Long, IStoreReference<T>> map) throws PersistentObjectException, BucketException;
